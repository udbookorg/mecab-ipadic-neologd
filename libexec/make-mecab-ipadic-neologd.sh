...
if [ ! -e ${BASEDIR}/../build/${ORG_DIC_NAME}.tar.gz ]; then
    DIST_SITE_URL_LIST=()
    DIST_SITE_URL_LIST[0]="https://sourceforge.net"
    DIST_SITE_URL_LIST[1]="https://drive.google.com"
    DIST_SITE_URL_LIST[2]="https://ja.osdn.net"
    ...
    ORG_DIC_URL_LIST[0]="https://sourceforge.net/projects/mecab/files/mecab-ipadic/2.7.0-20070801/mecab-ipadic-2.7.0-20070801.tar.gz/download?use_mirror=autoselect#"
    ...
    ORG_DIC_URL_LIST[2]="https://ja.osdn.net/frs/g_redir.php?m=kent&f=mecab%2Fmecab-ipadic%2F2.7.0-20070801%2F${ORG_DIC_NAME}.tar.gz"
